...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row" style="margin-bottom:15px;">
        <div class="col-lg-9 col-sm-12">
            <label>De click si desea adquirir un nuevo cupón.</label>
        </div>
    ...
    <asp:Gridview ID="grvLista" runat="server" CssClass="table table-hover overflow-auto" DataKeyNames="ID" GridLines="Vertical" CellPadding="4" AutoGenerateColumns="false" OnSelectedIndexChanged="grvLista_SelectedIndexChanged">
        <Columns>
            ...
            <asp:BoundField DataField="CuponID" HeaderText="Código del cupón:"></asp:BoundField>
            <asp:BoundField DataField="Fecha" HeaderText="Fecha de Adquisición:"></asp:BoundField>
        </Columns>
